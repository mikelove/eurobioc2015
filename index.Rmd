...
<img width=400 src="figures/ivt_percent_var.png">
...
<img width=450 src="figures/genelength.png">
...
* Differential tx usage doesn't necessarily lead to large bias
  * Among multi-isoform genes, most tx are similar length:
...
* Charlotte Soneson and Mark Robinson have extensively studied using
  these quant methods + Bioconductor pkgs, manuscript in preparation
